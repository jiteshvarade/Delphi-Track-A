...
export default function Toast({ message, type, onClose, duration = 5000 }: ToastProps) {
  ...
  const getStyles = () => {
    switch (type) {
      ...
      case 'info':
        return 'bg-blue-50 dark:bg-blue-900/20 border-blue-500 text-blue-900 dark:text-blue-100'
    }
  }
  ...
  return (
    <div className="fixed top-20 right-4 z-[9999] animate-slide-down">
      <div className={`flex items-start gap-3 min-w-[320px] max-w-md p-4 rounded-lg border-l-4 shadow-2xl ${getStyles()}`}>
